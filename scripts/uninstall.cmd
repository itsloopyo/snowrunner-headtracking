@echo off
:: ============================================
:: SnowRunner Head Tracking - Uninstall
:: ============================================
...
:: own directory. This mod deploys into Sources\Bin and writes its INI and log
:: there too, so MOD_LEFTOVERS covers them and the root holds nothing of ours.
set "ROOT_EXTRAS="
