...
// HeadTracking.ini. oracle_reader.cpp compiles v0.2.0's reader from byte copies
...
struct Published {
    ...
    // Whether head yaw turned about world up at startup.
    bool world_yaw = false;
    // What InstallCameraHook was handed.
    float fov_degrees = 0;
...
// What v0.2.0's WriteDefaultConfigIfMissing writes into `exe_dir` on a first
